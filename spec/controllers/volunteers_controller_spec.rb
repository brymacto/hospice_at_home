...
RSpec.describe VolunteersController, type: :controller do
  ...
  describe 'availability POST' do
    it 'redirects user to volunteer edit page and displays flash message when there are validation errors' do
      post(:add_volunteer_availabilities,
           ...
           availability: { start_hour: 9, end_hour: 10, day: '' }
          )
  ...
  describe '#add_volunteer_availabilities' do
    it 'does not add invalid availability' do
      get :add_volunteer_availabilities, id: test_volunteer.id, availability: { start_hour: '9', end_hour: '8', day: 'monday', volunteer_id: test_volunteer.id }
    ...
    it 'adds valid availability' do
      post :add_volunteer_availabilities, id: test_volunteer.id, availability: { start_hour: '9', end_hour: '10', day: 'monday', volunteer_id: test_volunteer.id }
      expect(assigns[:availabilities].size).to eq(1)
    end

    it 'redirects to volunteer show view' do
      get :add_volunteer_availabilities, id: test_volunteer.id, availability: { start_hour: '9', end_hour: '10', day: 'monday', volunteer_id: test_volunteer.id }
